...
const BLOG = {
  ...
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'ce04dd3cef1448b7a2f35f1077faab89',
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://or4444.notion.site', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
